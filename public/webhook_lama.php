<?php
require 'helpers/certificate.php';
...
if (
    ...
    // isset($rawData['email'], $rawData['nama_peserta'], $rawData['tanggal_training'], $rawData['divisi'], $rawData['fasilitas_kesehatan'])
) {
    $email = $data['email'];
    ...
    $phone = $data['no._handphone'] ?? ''; // Jika tidak ada, set ke string kosong
