            ...
            fetch(form.action, {
                ...
                .then(response => {
                    if (response.redirected) {
                        ...
                        return response.json(); // Jika tidak ada redirect, proses JSON
                    }
                })
                .then(data => {
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="flex flex-col md:flex-row max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="w-full md:w-1/2 bg-cover bg-center h-40 md:h-auto" style="background-image: url('');">
        </div>
        <div class="w-full md:w-1/2 p-6">
            ...
            <form id="kuisionerForm" action="<?= Config::BASE_URL ?>/participants" method="POST" class="flex flex-col"
                ...
                <label for="division" class="text-sm font-semibold">Divisi</label>
