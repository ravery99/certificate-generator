<!-- Navbar -->
<div
    class="fixed top-0 left-0 w-full sm:left-64 sm:w-[calc(100%-16rem)] h-16 bg-[#102C57] flex items-center px-4 shadow-md z-50">
    ...
    <!-- Profile Icon -->
    <div id="app" class="ml-auto flex items-center space-x-3">
    <div class="p-2 bg-gray-700 rounded-full hover:bg-gray-600 transition duration-300">
        <svg class="h-8 w-8 text-gray-300 hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
